...
``classify`` (print the language/bank/doctype verdict), ``scan`` (walk a
directory, one row per PDF), and ``extract-text`` (dump PDF text, optionally
showing which rules fired). Plus their formatting/rule-trace helpers.
"""
